...
PACKAGENAME = metadata.get('package_name', 'mirapy')
DESCRIPTION = metadata.get('description', 'Python package for Machine Learning in Astronomy')
AUTHOR = metadata.get('author', 'Swapnil Sharma, Akhil Singhal')
AUTHOR_EMAIL = metadata.get('author_email', '')
LICENSE = metadata.get('license', 'unknown')
URL = metadata.get('url', 'https://github.com/swapsha96/MiraPy')
__minimum_python_version__ = metadata.get("minimum_python_version", "3.5")

# Enforce Python version check - this is the same check as in __init__.py but
# this one has to happen before importing ah_bootstrap.
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: mirapy requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
...
setup(name=PACKAGENAME,
      ...
      extras_require={'docs': ['nbsphinx', 'sphinx-autoapi']},
      author=AUTHOR,
